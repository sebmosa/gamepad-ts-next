try {
    ...
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let p of pe(t))
        !ue.call(e, p) &&
          ...
          H(e, p, {
            get: () => t[p],
            enumerable: !(o = le(t, p)) || o.enumerable,
          })
    return e
  }
  var ce = (e, t, s) => (
    ...
    me(
      t || !e || !e.__esModule
        ? H(s, 'default', { value: e, enumerable: !0 })
        : s,
      e
    )
  )
        ...
        function r(n, y) {
          if (!g[n]) {
            if (!p[n]) {
              ...
              if (!y && u) return u(n, !0)
              if (i) return i(n, !0)
              var b = new Error("Cannot find module '" + n + "'")
          ...
          3: [
            function (o, p, g) {
              ...
              p.exports = function (n) {
                ...
                return function (b) {
                  var l = function () {
                    ...
                    for (E = 0; E < I; E++) {
                      if (
                        ((k[E] = { cacheItem: a, arg: arguments[E] }),
                        a.has(arguments[E]))
                      ) {
                        a = a.get(arguments[E])
                        continue
              ...
              function r(n, y) {
                ...
                for (a = 0; a < u; a++) {
                  for (l = !0, d = 0; d < b; d++)
                    if (!x(n[a][d].arg, y[d].arg)) {
                      l = !1
                      break
                    }
                  if (l) break
                }
                n.push(n.splice(a, 1)[0])
              }
              function i(n) {
                var y = n.length,
                  u = n[y - 1],
                ...
                for (
                  ...
                  l >= 0 &&
                  ((u = n[l]), (b = u.cacheItem.get(u.arg)), !b || !b.size);
                  l--
                )
  ...
  var w = 'storybook/viewport',
    ...
    fe = (e, t) => {
      let s = W(e, t)
      return s === e.length - 1 ? e[0] : e[s + 1]
    },
    ge = (e, t) => {
      let s = W(e, t)
      return s < 1 ? e[e.length - 1] : e[s - 1]
    },
    F = async (e, t, s) => {
      await e.setAddonShortcut(w, {
        ...
        actionName: 'previous',
        action: () => {
          let { selected: o, isRotated: p } = e.getAddonState(w)
          t({ selected: ge(s, o), isRotated: p })
        },
      }),
        await e.setAddonShortcut(w, {
          label: 'Next viewport',
        ...
        await e.setAddonShortcut(w, {
          ...
          actionName: 'reset',
          action: () => {
            let { isRotated: o } = e.getAddonState(w)
            t({ selected: 'reset', isRotated: o })
          },
        })
    }
  m()
  ...
  var ye = (0, D.default)(50)((e) => [
      ...be,
      ...Object.entries(e).map(([t, { name: s, ...o }]) => ({
        ...o,
        id: t,
        title: s,
      })),
    ...
    Ie = ({ width: e, height: t, ...s }) => ({ ...s, height: e, width: t }),
    ...
    _e = $(
      re(({ theme: e }) => {
        let {
            viewports: t = G,
            defaultOrientation: s = 'portrait',
            defaultViewport: o = P.id,
            disable: p,
          } = J(q, {}),
          [g, h] = Z(w, { selected: o, isRotated: s === 'landscape' }),
          r = ye(t),
          i = Q(),
          [x, n] = X(!1)
        r.find((d) => d.id === o) ||
          console.warn(
            `Cannot find "defaultViewport" of "${o}" in addon-viewport configs, please check the "viewports" setting in the configuration.`
          ),
          L(() => {
            F(i, h, Object.keys(t))
          }, [t]),
          L(() => {
            h({
              selected: o || (t[g.selected] ? g.selected : P.id),
              isRotated: g.isRotated,
            })
          }, [o])
