            ...
            function (o, i, g) {
                ...
                return function (S) {
                  var p = function () {
                    var y = h,
                      ...
                      x = !0,
                      k
                    if ((p.numArgs || p.numArgs === 0) && p.numArgs !== I + 1)
                      throw new Error(
                        'Memoizerific functions should always be called with the same number of arguments'
                      )
                    for (k = 0; k < I; k++) {
                      if (
                        ((A[k] = { cacheItem: y, arg: arguments[k] }),
                        y.has(arguments[k]))
                      ) {
                        y = y.get(arguments[k])
                        continue
                    ...
                    return (
                      ...
                      x ||
                        ...
                        y.set(arguments[I], B)),
                      a > 0 &&
                        ((A[I] = { cacheItem: y, arg: arguments[I] }),
                        x ? n(c, A) : c.push(A),
              ...
              function r(a) {
                ...
                for (
                  ...
                  p >= 0 &&
                  ((c = a[p]), (S = c.cacheItem.get(c.arg)), !S || !S.size);
                  p--
                )
        ...
        : b.createElement(
            ...
            b.createElement(
              ee,
              {
                ...
                tooltip: ({ onHide: r }) =>
                  b.createElement(X, {
                    links: me(e.values, l, ({ selected: u }) => {
                      l !== u && n(u), r()
                    }),
                  }),
                onVisibleChange: s,
